...
static void rtcHandler(){printf("rtc interrupt handler called");while(1){}}
static void kbHandler(){printf("keyboard interrupt handler called");while(1){};}
static void sysCallHandler(){printf("system call handler called");while(1){};}
static void divZeroHandler(){printf("Exception: Divide Error");while(1){};}
static void resHandler(){printf("Exception: RESERVED");while(1){};}
static void nmiHandler(){printf("NMI Interrupt");while(1){};}
static void bpHandler(){printf("Exception: Breakpoint");while(1){};}
static void ofHandler(){printf("Exception: Overflow");while(1){};}
static void breHandler(){printf("Exception: BOUND Range Exceeded");while(1){};}
static void invopHandler(){printf("Exception: Invalid Opcode");while(1){};}
static void dnaHandler(){printf("Exception: Device Not Available");while(1){};}
static void dfHandler(){printf("Exception: Double Fault");while(1){};}
static void csoHandler(){printf("Exception: Coprocessor Segment Overrun");while(1){};}
static void itssHandler(){printf("Exception: Invalid TSS");while(1){};}
static void snpHandler(){printf("Exception: Segment Not Present");while(1){};}
static void ssfHandler(){printf("Exception: Stack-Segment Fault");while(1){};}
static void gpHandler(){printf("Exception: General Protection");while(1){};}
static void pfHandler(){printf("Exception: Page Fault");while(1){};}
static void mfHandler(){printf("Exception: Math Fault");while(1){};}
static void acHandler(){printf("Exception: Alignment Check");while(1){};}
static void mcHandler(){printf("Exception: Machine Check");while(1){};}
static void simdfpHandler(){printf("Exception: SIMD Floating-Point");while(1){};}

void init_idt(){
// irq0 = rtc
idt_desc_t irq0;
irq0.seg_selector = KERNEL_CODE_SEGMENT;
irq0.dpl = 0; //privilege level =0 (kernel)
SET_IDT_ENTRY(irq0, &rtcHandler);
idt[0x20] = irq0;
